 ...
 */
public class BenDiAdapter extends CursorAdapter {
    // 用来加载生成视频预览图的线程池
    ...
    public BenDiAdapter(Context context) {
        super(context, null, true);
    }

    @Override
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return new BenDiView(context);
    }

    @Override
    public void bindView(View view, Context context, Cursor cursor) {
        final BenDiView localVidioView = (BenDiView) view;
        // 将当前数据,设置到视图上
